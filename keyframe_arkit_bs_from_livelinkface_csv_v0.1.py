...
def keyframe_arkit_bs_from_csv_file(
    ...
    for ii in range(frame_num):
        ...
        if armature_obj_name and armature_obj_name in bpy.data.armatures.keys():
            ...
            insert_pose_keyframe_at(armature_obj_name, pose_data_list, cur_key_frame_id)
...
if __name__ == "__main__":
    ...
    clear_animation_data(head_mesh_obj_name)
    clear_animation_data(teeth_mesh_obj_name)
    clear_animation_data(armature_obj_name)
